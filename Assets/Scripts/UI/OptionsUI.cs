...
public class OptionsUI : MonoBehaviour {
    ...
    private void Awake() {
        Instance = this;
        // soundEffectsSlider.value = SoundManager.Instance.GetVolume() * 10f;
        // musicSlider.value = MusicManager.Instance.GetVolume() * 10f;
        soundEffectsSlider.onValueChanged.AddListener((value) => {
            SoundManager.Instance.ChangeVolume(value / 10f);
            soundEffectsText.text = (Mathf.Round(value)).ToString();
            UpdateVisual();
        });
    ...
    private void UpdateVisual() {
        soundEffectsText.text = (Mathf.Round(SoundManager.Instance.GetVolume() * 10f)).ToString();
